                ...
                if ((!$blank && isset($_POST['submit'])) || isset($_POST['all'])) {   
                    if (count($id) != 0) {                
                        ...
                        for (; $count <= count($id); $count++) {
                            ...
                            echo '<td><div class="d-flex justify-content-around"><a class="btn btn-primary" href="edit.php?empID="' . $id[$count-1] . '">Edit</a> <a class="btn btn-danger" href="delete.php?empID="' . $id[$count-1] . '">Delete</a></div></td>';
                            echo '</tr>';
                        }
                        echo '</tbody>';
                        echo '</table>';
